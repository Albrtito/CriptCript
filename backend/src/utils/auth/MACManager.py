...
class MACManager:
    ...
    @staticmethod
    def create_cleartext_HMAC(data:str, key: bytes) -> bytes:
        """
    ...
    @staticmethod
    def create_ciphered_HMAC(ciphered_data:bytes, key: bytes) -> bytes:
        """
        Creates an HMAC based on the key, data and algorithm defined.
        + The algorithm is always sha256
        """
    ...
    @staticmethod
    def verify_cleartext_HMAC(data:str, key:bytes, hmac_value:bytes) -> bool:
        """
    ...
    @staticmethod
    def verify_ciphered_HMAC(ciphered_data:bytes , key:bytes, hmac_value:bytes) -> bool:
        """
        Verifies the HMAC valeu for some key and some data
        """
